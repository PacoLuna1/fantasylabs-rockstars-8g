"""
Django settings for fantasylabs project.
...
SECRET_KEY = 'django-insecure-l+pe1g2zon1vdo@ug8o_o7bpj^=+$gqxe#oi-2c6pfwf#jr)ef'
...
WSGI_APPLICATION = 'fantasylabs.wsgi.application'
